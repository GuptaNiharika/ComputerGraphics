...
/*void mykey2(unsigned char key, int x, int y) {
        ...
        drawString2(350, 100, 0, "Press the E or e to RUN");
...
void display1() {
    ...
    glColor3f(0.0, 0.0, 1.0);
    drawString1(125, 400, 0, " LINK STATE ROUTING ALGORITHM - CG Mini Project");
    glLineWidth(5);
    //drawString1(125, 300, 0, " CG Mini Project - LINK STATE ROUTING ALGORITHM ");
        glColor3f(1.0, 0.0, 0.0);

    drawString1(125, 250, 0, " CMR Institute of Technology");
    drawString1(125, 200, 0, " - Pragyat Singh (1CR15CS110)");
    drawString1(125, 150, 0, " - Niharika Gupta (1CR15CS104)");
